...
Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                       ...
                       * Don't worry about the indent, we strip it!
                       DESC
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/JAQDiceView"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Javier Querol" => "querol.javi@gmail.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/JAQDiceView.git", :tag => s.version.to_s }
